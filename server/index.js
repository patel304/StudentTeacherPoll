...
const usernameToSocketIds = new Map(); // username -> Set(socketId)

const pollsById = new Map(); // pollId -> poll
const pollsByTeacher = new Map(); // teacherUsername -> [poll]
...
httpServer.listen(PORT, () => {
	console.log(`API and Socket.IO server listening on http://localhost:${PORT}`);
});